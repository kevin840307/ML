...
class AttentionUNet(Model):
    ...
    def buind_network(self):
        ...
        with tf.variable_scope("decoder"):
            ...
            concat1 = tf.concat([attention1, conv1_1], axis=-1)
...
if __name__ == '__main__':
    ...
    import os
    import tool
    network = AttentionUNet("AttentionUNet", 8, 128, 128)
